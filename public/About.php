...
<h2 class="text-center">This is the Host Application's About Page!</h2>
<hr>
<h3>About this application...</h3>
<p>The PHP User Manager recreates the functionality of .NET's Web Site Administration Tool (WSAT), allowing you to easily manage users, roles, and access. It is an extension of my tutorial, <a href="https://github.com/garciart/MasterPagesInPHP" title="Master Pages in PHP" target="_blank">Master Pages in PHP</a>. Since it uses SQLite, you can simply download it and add it to your project, or you can clone it and use it as the foundation of your own web site.</p>
<h3>Steps:</h3>
<p>To add it to your web site:</p>
<ol>
    <li>Copy the UserManager folder and its contents into the root directory of your project.</li>
    <li>Open the Config.php file in the UserManager folder and edit the $ROOT_DIR and $APPLICATION_ROOT_DIR values so they match the folders of your project. You can also change the $ERROR_REPORTING value to "dev" for development.</li>
    <li>Add a link to LoginPage.php to your project.</li>
</ol>
<p>And that's it.</p>
<blockquote>
    <p><em><strong>Please note that the focus of this repo is the code in the UserManager folder, which is meant to be copied, pasted, and integrated into a project through a link to the Login page. For that reason, this repo does not attempt to apply a Symfony, Laravel, or Codeigniter folder structure.</strong></em></p>
</blockquote>
<hr>
<h3>Background:</h3>
